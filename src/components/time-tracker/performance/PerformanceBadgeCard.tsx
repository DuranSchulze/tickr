      ...
      {hasData ? (
        <>
          <div className="mt-6 grid gap-4 sm:grid-cols-[auto_minmax(0,1fr)] sm:items-center sm:gap-8">
            <p className="m-0 font-heading text-6xl font-black tracking-tight text-foreground tabular-nums sm:text-7xl">
              {score}
              <span className="ml-1 text-xl font-medium tracking-normal text-muted-foreground">
                /100
              </span>
            </p>
          ...
          <dl className="m-0 mt-6 grid grid-cols-3 gap-3 border-t border-border pt-5 sm:gap-6">
            {[
              {
                label: 'Days tracked',
        ...
        <p className="m-0 mt-6 text-sm leading-6 text-muted-foreground">
