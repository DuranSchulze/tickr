...
import type { ReportsMemberBreakdown } from '#/lib/server/tracker/reports.server'
import { formatCurrency } from '#/lib/time-tracker/billing'

const PAGE_SIZE = 10

type SortKey = keyof Pick<
  ReportsMemberBreakdown,
...
export function ReportsMemberBreakdownTable({
  members,
  currency,
  onViewMember,
}: {
  members: ReportsMemberBreakdown[]
  currency: string
