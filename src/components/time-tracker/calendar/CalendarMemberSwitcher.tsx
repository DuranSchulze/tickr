...
export function CalendarMemberSwitcher({
  ...
  return (
    <section className="flex min-w-0 flex-col gap-3 rounded-xl border border-stone bg-eggshell p-4 shadow-[var(--shadow-whisper)] sm:flex-row sm:items-end sm:justify-between">
      ...
      <fieldset className="m-0 w-full min-w-0 border-0 p-0 sm:max-w-sm">
        <legend className="mb-1 block text-xs font-semibold text-smoke">
          Calendar owner
        </legend>
        <Combobox
          ...
          className="rounded-xl font-semibold focus-visible:ring-2 focus-visible:ring-primary/40"
        />
      </fieldset>
    </section>
  )
