...
/**
 * Whether the visitor has asked for reduced motion. Read at module scope and
 * again per mount so a mid-session preference change is picked up.
 */
...
export default function ColorBends({
  ...
  useEffect(() => {
    ...
    // The canvas is decorative background art: never let it swallow clicks or
    // hover on the content layered above it.
    ...
    const loop = () => {
      ...
      // Honour prefers-reduced-motion: still paint, but never animate.
      if (!prefersReducedMotion()) rafRef.current = requestAnimationFrame(loop)
    }
    loop()
