...
function DefaultLoader() {
  return (
    <div className="bg-eggshell/50 absolute inset-0 z-10 flex items-center justify-center backdrop-blur-xs">
...
function DefaultMarkerIcon() {
  return (
    <div className="relative h-4 w-4 rounded-full border-2 border-white bg-blue-500 shadow-[var(--shadow-whisper)]" />
  )
}
...
function MarkerPopup({
  ...
  return createPortal(
    <div
      className={cn(
        'bg-popover text-popover-foreground relative max-w-62 rounded-md border p-3 shadow-[var(--shadow-whisper)]',
...
function MarkerTooltip({
  ...
  return createPortal(
    <div
      className={cn(
        'bg-foreground text-background pointer-events-none rounded-md px-2 py-1 text-xs text-balance shadow-[var(--shadow-whisper)]',
        'animate-in fade-in-0 zoom-in-95 duration-200 ease-out',
        className,
      )}
    >
...
function ControlGroup({ children }: { children: React.ReactNode }) {
  return (
    <div className="border-stone bg-eggshell [&>button:not(:last-child)]:border-stone flex flex-col overflow-hidden rounded-md border shadow-[var(--shadow-whisper)] [&>button:not(:last-child)]:border-b">
      {children}
    </div>
  )
}
