...
| Token | Light | Dark |
|---|---|---|
| `--sidebar` | `oklch(0.986 0.002 67.8)` | `oklch(0.214 0.009 43.1)` |
| `--sidebar-foreground` | `oklch(0.147 0.004 49.3)` | `oklch(0.986 0.002 67.8)` |
...
| `--sidebar-accent` | `oklch(0.96 0.002 17.2)` | `oklch(0.268 0.011 36.5)` |
| `--sidebar-accent-foreground` | `oklch(0.214 0.009 43.1)` | `oklch(0.986 0.002 67.8)` |
| `--sidebar-border` | `oklch(0.922 0.005 34.3)` | `oklch(1 0 0 / 10%)` |
| `--sidebar-ring` | `oklch(0.714 0.014 41.2)` | `oklch(0.547 0.021 43.1)` |
...
**Effective radius:** With `--radius: 0`, all corners are sharp (square). Common explicit radius overrides:

| Class | Use |
|---|---|
| `rounded-md` | Buttons, inputs, dropdowns |
| `rounded-lg` | Card borders |
| `rounded-xl` | Cards, dialogs, sidebar workspace box |
| `rounded-2xl` | App logo container |
| `rounded-full` | Avatars, pill buttons, dots |
